...
class CRM_Esr_Form_Task_Contact extends CRM_Contact_Form_Task {
  ...
  public function postProcess() {
    ...
    $values = array(
        ...
        'qr_type'             => $all_values['qr_type'] ?? NULL,
        'qr_version'          => $all_values['qr_version'] ?? NULL,
        'qr_coding_type'      => $all_values['qr_coding_type'] ?? NULL,
        'qr_account'          => $all_values['qr_account'] ?? NULL,
        'esr_reference_type'  => $all_values['esr_reference_type'] ?? NULL,
        'ze_address_type'     => $all_values['ze_address_type'] ?? NULL,
        'ze_name'             => $all_values['ze_name'] ?? NULL,
        'ze_street'           => $all_values['ze_street'] ?? NULL,
        'ze_street_number'    => $all_values['ze_street_number'] ?? NULL,
        'ze_postal_code'      => $all_values['ze_postal_code'] ?? NULL,
        'ze_city'             => $all_values['ze_city'] ?? NULL,
